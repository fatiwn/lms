...
<div class="row">
	...
	<div class="col-sm-4 col-sm-offset-4">
		<div class="panel panel-success">
			...
			<!-- <div class="panel-heading"> signin neee
			...
			<div class="panel-body">
				<form method="post" action="index.php">
					...
					<div>
						<input type="radio" name="gender" id="student" value="student" required>
      					<label for="student" style="color:rgb(167, 157, 157);">student</label><br>
      					<input type="radio" name="gender" id="lecturer" value="lecturer" required>
      					<label for="lecturer" style="color: rgb(167, 157, 157);">lecturer</label><br>     
      					<input type="radio" name="gender" id="admin " value="admin" required>
      					<label for="admin" style="color: rgb(167, 157, 157);">admin </label>	
					</div>
					<div class="checkbox">
