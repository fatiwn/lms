...
<head>
  ...
  <title><?php echo ucwords('Database Project'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="quiz-view.php"><i class="fa fa-puzzle-piece"></i> <span>Quiz</span></a></li>
        <li><a href="assignment_view.php"><i class="fa fa-folder"></i> <span>Assignment</span></a></li>
        <li class="treeview">
